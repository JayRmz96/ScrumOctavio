...
export class ServicioPlayera {
  ...
  tomarJsonSlide() {
    ...
    return this._http.get(this.url + 'mostrar-playeras').pipe(map(resultado => resultado.json()));
  }

  subirImagenPlayera(url, items, token, imagen) {
  ...
  actualizarItemPlayera(url, items, token, imagen) {
  ...
  borrarItemSlide(id) {
    ...
    return this._http.delete(this.url + 'borrar-playeras/' + id, {headers: headers}).pipe(map(resultado => resultado.json()));
